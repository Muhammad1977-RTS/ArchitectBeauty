...
class MasterTransportScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Мои перевозки')),
        ...
        data: (orders) {
          ...
          return RefreshIndicator(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, i) => _TransportCard(order: orders[i]),
            ),
          );
        },
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _AddressRow(
                  icon: Icons.arrow_upward, color: AppColors.secondary, text: order.fromAddress),
              const SizedBox(height: 4),
              _AddressRow(
                  icon: Icons.arrow_downward, color: AppColors.error, text: order.toAddress),
              if (order.budget != null || order.cargoWeightKg != null) ...[
                ...
                const Align(
                  ...
                  child: Icon(Icons.arrow_forward_ios, size: 14, color: AppColors.border),
                ),
              ],
            ],
          ),
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            const Text(
              'Новый заказ на перевозку',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 4),
            const Text(
              'Перевозка инструментов или стройматериалов',
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                  labelText: 'Что везём *',
                  hintText: 'Инструменты, плитка, мешки цемента...',
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    decoration:
                        const InputDecoration(labelText: 'Вес (кг)', suffixText: 'кг'),
                  ),
                ),
                ...
                Expanded(
                  child: TextField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration:
                        const InputDecoration(labelText: 'Бюджет (₽)', suffixText: '₽'),
                  ),
                ),
              ],
            ),
